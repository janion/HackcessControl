...
def do_setup():
    ...
    os.mkdir("smart_home/client/implementations/example/esp8266/relay")
    ...
    os.rename("RelayClient.py", "smart_home/client/implementations/example/esp8266/button/RelayClient.py")
